...
public class SignAddressActivity extends BaseMapActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getString(R.string.txt_title_address));
        sign = (Sign) getIntent().getSerializableExtra("sign");
        //真正的数据时，要删除 TODO
        sign=new Sign();
        sign.setSignLatitude(30.599736);
        sign.setSignLatitude(114.309876);
        ...
        CircleOptions circleOptions = new CircleOptions().center(ll).radius(((int) accuracy)).fillColor(0x00000000).stroke(new Stroke(1, 0xAA0099CC));
