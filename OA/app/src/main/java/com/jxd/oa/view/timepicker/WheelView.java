...
public class WheelView extends View {
     ...
     */
    private static final int VALUE_TEXT_COLOR = 0xF0474747;

    /**
     * Items text color
     */
    private static final int ITEMS_TEXT_COLOR = 0xFF474747;

    /**
     * Top and bottom shadows colors
     */
    // private static final int[] SHADOWS_COLORS = new int[]{0xFF111111,0x00AAAAAA, 0x00AAAAAA};
    private static final int[] SHADOWS_COLORS = new int[]{0xFFE8E8E8, 0x00F1F1F1, 0x00F7F7F7};
     ...
     */
    private static final int DEF_VISIBLE_ITEMS = 5;//默认显示个数
    ...
    private void initResourcesIfNecessary() {
        ...
        if (valuePaint == null) {
            valuePaint = new TextPaint(Paint.ANTI_ALIAS_FLAG | Paint.DITHER_FLAG);//  | Paint.FAKE_BOLD_TEXT_FLAG  粗休
